...
export default function Page() {
  return (
    <Wrapper>
      <article className="max-w-4xl pt-30 text-gray-100">
        <h1 className="mt-0 mb-8 text-4xl font-bold text-white">
          Политика в отношении обработки персональных данных
        </h1>

        <section className="mb-8">
          <h2 className="mt-6 mb-4 text-2xl font-semibold text-gray-50">
            1. Общие положения
          </h2>
          <p className="mb-4 leading-relaxed text-gray-300">
            ...
            Николаенко Александр Иванович (далее — Оператор).
          </p>
          <p className="mb-4 leading-relaxed text-gray-300">
          ...
          <p className="mb-4 leading-relaxed text-gray-300">
            ...
            https://cv-rose-omega.vercel.app/.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <dl className="space-y-3">
            ...
            <div className="border-l-2 border-gray-600 pl-4">
              <dt className="font-semibold text-gray-100">
                <strong>2.8. Персональные данные</strong>
              </dt>
              <dd className="mt-1 text-gray-400">
            ...
            <div className="border-l-2 border-gray-600 pl-4">
              <dt className="font-semibold text-gray-100">
                <strong>2.10. Пользователь</strong>
              </dt>
              <dd className="mt-1 text-gray-400">
                любой посетитель веб-сайта https://cv-rose-omega.vercel.app/.
              </dd>
            </div>
        ...
        <section className="mb-8">
          ...
          <h3 className="mt-4 mb-3 text-xl font-semibold text-gray-100">
        ...
        <section className="mb-8">
          <h2 className="mt-6 mb-4 text-2xl font-semibold text-gray-50">
            4. Основные права и обязанства субъектов персональных данных
          </h2>
          <h3 className="mt-4 mb-3 text-xl font-semibold text-gray-100">
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="border border-gray-600 bg-gray-800">
                  <th className="border border-gray-600 p-3 text-left font-semibold text-gray-100">
                    Цель обработки
                  </th>
                  <th className="border border-gray-600 p-3 text-left font-semibold text-gray-100">
                    Персональные данные
              ...
              <tbody>
                <tr className="hover:bg-gray-850 border border-gray-600 bg-gray-900">
        ...
        <section className="mb-8">
          ...
          <ol className="list-inside list-decimal space-y-2 text-gray-300">
            ...
            <li>
              ...
              nikol.alex06@mail.ru с пометкой «Актуализация персональных
              данных».
            </li>
            <li>
              ...
              <p className="mt-2 border-l-2 border-gray-600 pl-4 text-gray-400">
                ...
                nikol.alex06@mail.ru с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed text-gray-300">
            ...
            https://cv-rose-omega.vercel.app/privacy.
          </p>
        </section>
      </article>
    </Wrapper>
