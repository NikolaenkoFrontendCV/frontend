...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Применяю Docker для контейнеризации frontend-приложений и упрощения локальной разработки и деплоя. Позволяет обеспечить一致ность окружений между разработкой и продакшеном.",
